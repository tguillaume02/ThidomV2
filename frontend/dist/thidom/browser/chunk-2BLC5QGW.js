...
var HistoryService = class _HistoryService {
  constructor(http) {
    this.http = http;
    this.apiUrl = `${environment.apiUrl}/history`;
  }
  getHistory(deviceId, field, start, end, aggregation, interval) {
  ...
  static {
    this.\u0275fac = function HistoryService_Factory(t) {
      return new (t || _HistoryService)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
...
function HistoryComponent_For_10_Template(rf, ctx) {
  if (rf & 1) {
...
function HistoryComponent_For_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const itv_r2 = ctx.$implicit;
    \u0275\u0275property("value", itv_r2.value);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(itv_r2.label);
  }
}
function HistoryComponent_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-bar", 8);
  }
}
function HistoryComponent_Conditional_26_For_27_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("title", ctx_r3.formatTime(point_r3.timestamp) + ": " + point_r3.value);
    \u0275\u0275advance();
    \u0275\u0275styleProp("height", ctx_r3.getBarHeight(point_r3.value), "%");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r3.formatTime(point_r3.timestamp));
  }
}
function HistoryComponent_Conditional_26_For_43_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r3.formatTime(point_r5.timestamp));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(point_r5.field);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(point_r5.value);
  }
}
function HistoryComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(26, HistoryComponent_Conditional_26_For_27_Template, 4, 4, "div", 17, _forTrack2);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(28, "div", 18)(29, "h3");
    \u0275\u0275text(30, "Donn\xE9es brutes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "div", 19)(32, "table")(33, "thead")(34, "tr")(35, "th");
    \u0275\u0275text(36, "Horodatage");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(42, HistoryComponent_Conditional_26_For_43_Template, 7, 3, "tr", null, _forTrack2);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r3.getMinValue());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r3.getMaxValue());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r3.getAvgValue());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r3.historyData.points.length);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r3.historyData.field, " \u2014 Derni\xE8res 24h");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r3.historyData.points);
    \u0275\u0275advance(16);
    \u0275\u0275repeater(ctx_r3.historyData.points);
  }
}
function HistoryComponent_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "mat-icon");
    \u0275\u0275text(2, "timeline");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p");
    \u0275\u0275text(4, "S\xE9lectionnez un appareil pour consulter son historique");
    \u0275\u0275elementEnd()();
  }
}
var HistoryComponent = class _HistoryComponent {
  constructor(historyService, deviceService) {
    this.historyService = historyService;
    this.deviceService = deviceService;
    this.devices = [];
    this.historizableDevices = [];
  ...
  loadHistory() {
    ...
    this.historyService.getHistory(this.selectedDeviceId, this.selectedField || void 0, start.toISOString(), now.toISOString(), void 0, this.interval).subscribe({
      next: (data) => {
  ...
  getMaxValue() {
    if (!this.historyData?.points.length)
      return 0;
  ...
  static {
    this.\u0275fac = function HistoryComponent_Factory(t) {
      return new (t || _HistoryComponent)(\u0275\u0275directiveInject(HistoryService), \u0275\u0275directiveInject(DeviceService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HistoryComponent, selectors: [["app-history"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 28, vars: 7, consts: [[1, "page-container", "fade-in"], [1, "page-header"], [1, "filters-row"], ["appearance", "outline", 1, "filter-field"], [3, "ngModelChange", "ngModel"], [3, "value"], ["matInput", "", "placeholder", "temperature, humidity...", 3, "ngModelChange", "ngModel"], ["mat-raised-button", "", "color", "primary", 3, "click", "disabled"], ["mode", "indeterminate", "color", "accent"], [1, "empty-state"], [1, "stats-row"], [1, "thidom-card", "stat-mini"], [1, "stat-label"], [1, "stat-value"], [1, "thidom-card", "chart-card"], [1, "chart-area"], [1, "bars-container"], [1, "bar-wrapper", 3, "title"], [1, "thidom-card", "data-table-card"], [1, "data-table"], [1, "bar"], [1, "bar-label"]], template: function HistoryComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275twoWayListener("ngModelChange", function HistoryComponent_Template_mat_select_ngModelChange_8_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.selectedDeviceId, $event) || (ctx.selectedDeviceId = $event);
          return $event;
        });
        \u0275\u0275listener("ngModelChange", function HistoryComponent_Template_mat_select_ngModelChange_8_listener() {
          return ctx.loadHistory();
        });
        \u0275\u0275repeaterCreate(9, HistoryComponent_For_10_Template, 2, 2, "mat-option", 5, _forTrack0);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(11, "mat-form-field", 3)(12, "mat-label");
        \u0275\u0275text(13, "Champ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(14, "input", 6);
        \u0275\u0275twoWayListener("ngModelChange", function HistoryComponent_Template_input_ngModelChange_14_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.selectedField, $event) || (ctx.selectedField = $event);
          return $event;
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(15, "mat-form-field", 3)(16, "mat-label");
        \u0275\u0275text(17, "Intervalle");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(18, "mat-select", 4);
        \u0275\u0275twoWayListener("ngModelChange", function HistoryComponent_Template_mat_select_ngModelChange_18_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.interval, $event) || (ctx.interval = $event);
          return $event;
        });
        \u0275\u0275repeaterCreate(19, HistoryComponent_For_20_Template, 2, 2, "mat-option", 5, _forTrack1);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(21, "button", 7);
        \u0275\u0275listener("click", function HistoryComponent_Template_button_click_21_listener() {
          return ctx.loadHistory();
        });
        ...
        \u0275\u0275text(24, " Charger ");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(25, HistoryComponent_Conditional_25_Template, 1, 0, "mat-progress-bar", 8)(26, HistoryComponent_Conditional_26_Template, 44, 5)(27, HistoryComponent_Conditional_27_Template, 5, 0, "div", 9);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(8);
        \u0275\u0275twoWayProperty("ngModel", ctx.selectedDeviceId);
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.historizableDevices);
        \u0275\u0275advance(5);
        \u0275\u0275twoWayProperty("ngModel", ctx.selectedField);
        \u0275\u0275advance(4);
        \u0275\u0275twoWayProperty("ngModel", ctx.interval);
        \u0275\u0275advance();
        \u0275\u0275repeater(ctx.intervals);
        \u0275\u0275advance(2);
        \u0275\u0275property("disabled", !ctx.selectedDeviceId || ctx.loading);
        \u0275\u0275advance(4);
        \u0275\u0275conditional(25, ctx.loading ? 25 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(26, ctx.historyData && ctx.historyData.points.length > 0 ? 26 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(27, !ctx.loading && !ctx.historyData ? 27 : -1);
      }
    }, dependencies: [
      CommonModule,
      FormsModule,
      ...
      MatDatepickerModule,
      MatNativeDateModule
    ], styles: ["\n\n.filters-row[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 16px;\n  margin-bottom: 20px;\n  flex-wrap: wrap;\n  align-items: center;\n}\n.filters-row[_ngcontent-%COMP%]   .filter-field[_ngcontent-%COMP%] {\n  min-width: 180px;\n  flex: 1;\n}\n.stats-row[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  gap: 16px;\n  margin-bottom: 20px;\n}\n.stats-row[_ngcontent-%COMP%]   .stat-mini[_ngcontent-%COMP%] {\n  text-align: center;\n  padding: 16px;\n}\n.stats-row[_ngcontent-%COMP%]   .stat-mini[_ngcontent-%COMP%]   .stat-label[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 0.8rem;\n  color: var(--thidom-text-secondary);\n  margin-bottom: 4px;\n}\n.stats-row[_ngcontent-%COMP%]   .stat-mini[_ngcontent-%COMP%]   .stat-value[_ngcontent-%COMP%] {\n  font-size: 1.6rem;\n  font-weight: 600;\n  color: var(--thidom-green);\n}\n.chart-card[_ngcontent-%COMP%] {\n  margin-bottom: 20px;\n}\n.chart-card[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  font-size: 1rem;\n  font-weight: 400;\n  color: var(--thidom-text-secondary);\n  margin-bottom: 16px;\n}\n.chart-card[_ngcontent-%COMP%]   .chart-area[_ngcontent-%COMP%] {\n  overflow-x: auto;\n}\n.chart-card[_ngcontent-%COMP%]   .chart-area[_ngcontent-%COMP%]   .bars-container[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 4px;\n  align-items: flex-end;\n  height: 200px;\n  padding-bottom: 30px;\n  position: relative;\n}\n.chart-card[_ngcontent-%COMP%]   .chart-area[_ngcontent-%COMP%]   .bars-container[_ngcontent-%COMP%]   .bar-wrapper[_ngcontent-%COMP%] {\n  flex: 1;\n  min-width: 20px;\n  max-width: 40px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: flex-end;\n  height: 100%;\n  cursor: pointer;\n}\n.chart-card[_ngcontent-%COMP%]   .chart-area[_ngcontent-%COMP%]   .bars-container[_ngcontent-%COMP%]   .bar-wrapper[_ngcontent-%COMP%]   .bar[_ngcontent-%COMP%] {\n  width: 100%;\n  background:\n    linear-gradient(\n      to top,\n      var(--thidom-green-dark),\n      var(--thidom-green-light));\n  border-radius: 3px 3px 0 0;\n  transition: height 0.3s;\n  min-height: 2px;\n}\n.chart-card[_ngcontent-%COMP%]   .chart-area[_ngcontent-%COMP%]   .bars-container[_ngcontent-%COMP%]   .bar-wrapper[_ngcontent-%COMP%]   .bar[_ngcontent-%COMP%]:hover {\n  background: var(--thidom-green-light);\n}\n.chart-card[_ngcontent-%COMP%]   .chart-area[_ngcontent-%COMP%]   .bars-container[_ngcontent-%COMP%]   .bar-wrapper[_ngcontent-%COMP%]   .bar-label[_ngcontent-%COMP%] {\n  font-size: 0.6rem;\n  color: var(--thidom-text-secondary);\n  margin-top: 4px;\n  transform: rotate(-45deg);\n  white-space: nowrap;\n}\n.data-table-card[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  font-size: 1rem;\n  font-weight: 400;\n  color: var(--thidom-text-secondary);\n  margin-bottom: 12px;\n}\n.data-table-card[_ngcontent-%COMP%]   .data-table[_ngcontent-%COMP%] {\n  max-height: 300px;\n  overflow-y: auto;\n}\n.data-table-card[_ngcontent-%COMP%]   .data-table[_ngcontent-%COMP%]   table[_ngcontent-%COMP%] {\n  width: 100%;\n  border-collapse: collapse;\n}\n.data-table-card[_ngcontent-%COMP%]   .data-table[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   th[_ngcontent-%COMP%], .data-table-card[_ngcontent-%COMP%]   .data-table[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   td[_ngcontent-%COMP%] {\n  padding: 8px 12px;\n  text-align: left;\n  border-bottom: 1px solid var(--thidom-border);\n  font-size: 0.85rem;\n}\n.data-table-card[_ngcontent-%COMP%]   .data-table[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   th[_ngcontent-%COMP%] {\n  color: var(--thidom-green);\n  font-weight: 500;\n  position: sticky;\n  top: 0;\n  background: var(--thidom-bg-card);\n}\n.data-table-card[_ngcontent-%COMP%]   .data-table[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   td[_ngcontent-%COMP%] {\n  color: var(--thidom-text-secondary);\n}\n.data-table-card[_ngcontent-%COMP%]   .data-table[_ngcontent-%COMP%]   table[_ngcontent-%COMP%]   tr[_ngcontent-%COMP%]:hover   td[_ngcontent-%COMP%] {\n  background: rgba(255, 255, 255, 0.03);\n}\n.empty-state[_ngcontent-%COMP%] {\n  text-align: center;\n  padding: 60px 20px;\n  color: var(--thidom-text-secondary);\n}\n.empty-state[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 4rem;\n  width: 64px;\n  height: 64px;\n  margin-bottom: 16px;\n  opacity: 0.4;\n}\n.empty-state[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  font-size: 1.2rem;\n  color: var(--thidom-text-primary);\n}\n/*# sourceMappingURL=history.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HistoryComponent, { className: "HistoryComponent", filePath: "src\\app\\features\\history\\history.component.ts", lineNumber: 36 });
})();
export {
  HistoryComponent
};
//# sourceMappingURL=chunk-2BLC5QGW.js.map
