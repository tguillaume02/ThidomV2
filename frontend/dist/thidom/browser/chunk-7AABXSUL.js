...
function LayoutComponent_For_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 6)(1, "mat-icon", 20);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function LayoutComponent_Conditional_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const user_r2 = ctx;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(user_r2.full_name || user_r2.username);
  }
}
var LayoutComponent = class _LayoutComponent {
  constructor(authService, wsService, router) {
    ...
    this.navItems = [
      ...
      { label: "Pi\xE8ces", icon: "meeting_room", route: "/rooms" },
      { label: "Appareils", icon: "devices", route: "/devices" },
      { label: "Plugins", icon: "extension", route: "/plugins" },
      { label: "Sc\xE9narios", icon: "auto_fix_high", route: "/scenarios" },
  ...
  static {
    this.\u0275fac = function LayoutComponent_Factory(t) {
      return new (t || _LayoutComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(WebSocketService), \u0275\u0275directiveInject(Router));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LayoutComponent, selectors: [["app-layout"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 30, vars: 9, consts: [[1, "layout-container"], ["mode", "side", 1, "sidebar", 3, "opened"], [1, "sidebar-header"], ["src", "assets/logo.svg", "alt", "ThiDom", 1, "logo"], [1, "app-title"], [1, "nav-list"], ["mat-list-item", "", "routerLinkActive", "active-link", 1, "nav-item", 3, "routerLink"], [1, "sidebar-footer"], [1, "ws-status"], [1, "status-indicator"], [1, "status-text"], [1, "main-content"], [1, "top-toolbar"], ["mat-icon-button", "", "matTooltip", "Menu", 3, "click"], [1, "toolbar-spacer"], [1, "user-name"], ["mat-icon-button", "", "matTooltip", "Notifications"], ["matBadge", "3", "matBadgeColor", "accent", "matBadgeSize", "small"], ["mat-icon-button", "", "matTooltip", "D\xE9connexion", 3, "click"], [1, "content-area"], ["matListItemIcon", ""], ["matListItemTitle", ""]], template: function LayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "mat-sidenav-container", 0)(1, "mat-sidenav", 1)(2, "div", 2);
        \u0275\u0275element(3, "img", 3);
        \u0275\u0275elementStart(4, "span", 4);
        \u0275\u0275text(5, "ThiDom");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(6, "mat-nav-list", 5);
        \u0275\u0275repeaterCreate(7, LayoutComponent_For_8_Template, 5, 3, "a", 6, _forTrack0);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(13);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(14, "mat-sidenav-content", 11)(15, "mat-toolbar", 12)(16, "button", 13);
        ...
        \u0275\u0275template(20, LayoutComponent_Conditional_20_Template, 2, 1, "span", 15);
        \u0275\u0275pipe(21, "async");
        \u0275\u0275elementStart(22, "button", 16)(23, "mat-icon", 17);
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275classProp("online", ctx.wsConnected)("offline", !ctx.wsConnected);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(ctx.wsConnected ? "Connect\xE9" : "D\xE9connect\xE9");
        \u0275\u0275advance(7);
        \u0275\u0275conditional(20, (tmp_5_0 = \u0275\u0275pipeBind1(21, 7, ctx.authService.currentUser$)) ? 20 : -1, tmp_5_0);
      }
    }, dependencies: [CommonModule, AsyncPipe, RouterModule, RouterOutlet, RouterLink, RouterLinkActive, MatSidenavModule, MatSidenav, MatSidenavContainer, MatSidenavContent, MatToolbarModule, MatToolbar, MatListModule, MatNavList, MatListItem, MatListItemIcon, MatListItemTitle, MatIconModule, MatIcon, MatButtonModule, MatIconButton, MatTooltipModule, MatTooltip, MatBadgeModule, MatBadge], styles: ["\n\n.layout-container[_ngcontent-%COMP%] {\n  height: 100vh;\n}\n.sidebar[_ngcontent-%COMP%] {\n  width: var(--sidebar-width);\n  background: var(--thidom-bg-sidebar);\n  border-right: 1px solid var(--thidom-border);\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n}\n.sidebar[_ngcontent-%COMP%]   .sidebar-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 20px 16px;\n  border-bottom: 1px solid var(--thidom-border);\n}\n.sidebar[_ngcontent-%COMP%]   .sidebar-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%] {\n  width: 40px;\n  height: 40px;\n  object-fit: contain;\n}\n.sidebar[_ngcontent-%COMP%]   .sidebar-header[_ngcontent-%COMP%]   .app-title[_ngcontent-%COMP%] {\n  font-size: 1.5rem;\n  font-weight: 700;\n  color: var(--thidom-green);\n  letter-spacing: 1px;\n}\n.sidebar[_ngcontent-%COMP%]   .nav-list[_ngcontent-%COMP%] {\n  flex: 1;\n  padding-top: 8px;\n  overflow-y: auto;\n  scrollbar-width: none;\n  -ms-overflow-style: none;\n}\n.sidebar[_ngcontent-%COMP%]   .nav-list[_ngcontent-%COMP%]::-webkit-scrollbar {\n  display: none;\n}\n.sidebar[_ngcontent-%COMP%]   .nav-list[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%] {\n  margin: 2px 8px;\n  border-radius: 8px;\n  color: var(--thidom-text-secondary);\n  transition: all 0.2s;\n}\n.sidebar[_ngcontent-%COMP%]   .nav-list[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%]:hover {\n  background: rgba(0, 230, 118, 0.08);\n  color: var(--thidom-text-primary);\n}\n.sidebar[_ngcontent-%COMP%]   .nav-list[_ngcontent-%COMP%]   .nav-item[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: var(--thidom-text-secondary);\n  margin-right: 12px;\n}\n.sidebar[_ngcontent-%COMP%]   .nav-list[_ngcontent-%COMP%]   .active-link[_ngcontent-%COMP%] {\n  background: rgba(0, 230, 118, 0.15) !important;\n  color: var(--thidom-green) !important;\n}\n.sidebar[_ngcontent-%COMP%]   .nav-list[_ngcontent-%COMP%]   .active-link[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: var(--thidom-green) !important;\n}\n.sidebar[_ngcontent-%COMP%]   .sidebar-footer[_ngcontent-%COMP%] {\n  padding: 16px;\n  border-top: 1px solid var(--thidom-border);\n}\n.sidebar[_ngcontent-%COMP%]   .sidebar-footer[_ngcontent-%COMP%]   .ws-status[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.sidebar[_ngcontent-%COMP%]   .sidebar-footer[_ngcontent-%COMP%]   .ws-status[_ngcontent-%COMP%]   .status-indicator[_ngcontent-%COMP%] {\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n}\n.sidebar[_ngcontent-%COMP%]   .sidebar-footer[_ngcontent-%COMP%]   .ws-status[_ngcontent-%COMP%]   .status-indicator.online[_ngcontent-%COMP%] {\n  background: var(--thidom-green);\n  box-shadow: 0 0 6px var(--thidom-green);\n}\n.sidebar[_ngcontent-%COMP%]   .sidebar-footer[_ngcontent-%COMP%]   .ws-status[_ngcontent-%COMP%]   .status-indicator.offline[_ngcontent-%COMP%] {\n  background: #f44336;\n}\n.sidebar[_ngcontent-%COMP%]   .sidebar-footer[_ngcontent-%COMP%]   .ws-status[_ngcontent-%COMP%]   .status-text[_ngcontent-%COMP%] {\n  font-size: 0.8rem;\n  color: var(--thidom-text-secondary);\n}\n.top-toolbar[_ngcontent-%COMP%] {\n  background: var(--thidom-bg-secondary);\n  border-bottom: 1px solid var(--thidom-border);\n  color: var(--thidom-text-primary);\n  height: 56px;\n}\n.top-toolbar[_ngcontent-%COMP%]   .toolbar-spacer[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.top-toolbar[_ngcontent-%COMP%]   .user-name[_ngcontent-%COMP%] {\n  font-size: 0.9rem;\n  color: var(--thidom-text-secondary);\n  margin-right: 8px;\n}\n.top-toolbar[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  color: var(--thidom-text-secondary);\n}\n.top-toolbar[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover {\n  color: var(--thidom-green);\n}\n.content-area[_ngcontent-%COMP%] {\n  height: calc(100vh - 56px);\n  overflow-y: auto;\n  background: var(--thidom-bg-primary);\n}\n/*# sourceMappingURL=layout.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LayoutComponent, { className: "LayoutComponent", filePath: "src\\app\\layout\\layout.component.ts", lineNumber: 37 });
})();
export {
  LayoutComponent
};
//# sourceMappingURL=chunk-7AABXSUL.js.map
