...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-VWW5BDPL.js").then((m) => m.LoginComponent)
  },
  {
    path: "",
    loadComponent: () => import("./chunk-7AABXSUL.js").then((m) => m.LayoutComponent),
    canActivate: [authGuard],
    children: [
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-5CWWQANY.js").then((m) => m.DashboardComponent)
      },
      {
        path: "rooms",
        loadComponent: () => import("./chunk-JIUL7LQW.js").then((m) => m.RoomsComponent)
      },
      {
        path: "devices",
        loadComponent: () => import("./chunk-LXBSOFFZ.js").then((m) => m.DevicesComponent)
      },
      {
        path: "plugins",
        loadComponent: () => import("./chunk-QYYNNZMY.js").then((m) => m.PluginsComponent)
      },
      {
        path: "scenarios",
        loadComponent: () => import("./chunk-ECLZFHNH.js").then((m) => m.ScenariosComponent)
      },
      {
        path: "schedules",
        loadComponent: () => import("./chunk-V6SOSNHM.js").then((m) => m.SchedulesComponent)
      },
      {
        path: "history",
        loadComponent: () => import("./chunk-2BLC5QGW.js").then((m) => m.HistoryComponent)
      },
      {
        path: "logs",
        loadComponent: () => import("./chunk-7KYWUUGP.js").then((m) => m.LogsComponent)
      },
      {
        path: "",
...
var authInterceptor = (req, next) => {
  const token = localStorage.getItem("thidom_token");
  if (token) {
    req = req.clone({
      setHeaders: {
